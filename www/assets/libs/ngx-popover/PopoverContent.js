...
var PopoverContent = (function () {
    ...
    PopoverContent.prototype.positionElements = function (hostEl, targetEl, positionStr, appendToBody) {
        ...
        var shiftHeight = {
            center: function () {
              // console.log('hostElPos.top ' + hostElPos.top);
              // console.log('hostElPos.height/2 ' + hostElPos.height / 2);
              // console.log('targetElHeight/2 ' + targetElHeight / 2);
    ...
    PopoverContent.prototype.position = function (nativeEl) {
        ...
        if (offsetParentEl !== window.document) {
            ...
            offsetParentBCR.top += offsetParentEl.clientTop + adjustY - offsetParentEl.scrollTop;
